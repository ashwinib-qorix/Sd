...
*******************************************************************************/
    ...
    #define SD_GET_VERSION_INFO                        STD_OFF
   ...
   #define SD_SET_REM_ADDR_OF_CLIENT_RX_MULTICAST_SO_CON           STD_ON
	 ...
	 #define SD_ENABLE_SECURITY_EVENT_REPORTING        STD_ON



#define SD_DBTOC_VALUE                   0       

#define SD_SEV_SOME_IP_ACL_CHECK_FAILED_OFFER                   IdsMConf_IdsMEvent_IdsMEvent_1_SOME_IP_SD_CLIENT_ACL_CHECK_FAILED_OFFER       

 #define SD_SEV_DUPLICATE_OFFER                                  IdsMConf_IdsMEvent_IdsMEvent_4_SOME_IP_SD_DUPLICATE_OFFER       
 
 #define SD_SEV_SOME_IP_ACL_CHECK_FAILED_EVENT_SUBSCRIPTION      IdsMConf_IdsMEvent_IdsMEvent_2_SOME_IP_SD_SERVER_ACL_CHECK_FAILED_EVENT_SUBSCRIPTION       
   
#define SD_SEV_SOME_IP_ACL_CHECK_FAILED_METHOD_REQUEST          IdsMConf_IdsMEvent_IdsMEvent_3_SOME_IP_SD_SERVER_ACL_CHECK_FAILED_METHOD_REQUEST       
   /* Pre-compile option for SdMainFunctionCycleTime  */
   #define SD_SEC_TO_COUNT                               100U

   /* Pre-compile option for Total Instances across all ConfigSets */
   #define SD_NO_OF_INSTANCES                            1U

   /* Pre-compile option for Sd no of Server Services */
   #define SD_NO_OF_SERVER_SERVICES                      2U

   /* Pre-compile option for Sd no of Handles */
   #define SD_NO_OF_EV_HANDLERS                          4U

   /* Pre-compile option for Sd Queue size */
   #define SD_QUEUE_SIZE                                 10U

   /* Pre-compile option for Sd no of Client services */
   #define SD_NO_OF_CLIENT_SERVICES                      1U

   /* Pre-compile option for Sd no of Consumed EV Group */
   #define SD_NO_OF_CONSUMED_EV_GRP                      3U

   /* Pre-compile option for number of server timers */
   #define SD_NO_OF_SERVER_TIMERS                        4U
   
   /* Pre-compile option for number of client timers */
   #define SD_NO_OF_CLIENT_TIMERS                        4U

   /* Pre-compile option for no of socket groups */
   #define SD_NO_OF_SO_CON_GRPS                          4U

   /* Pre-compile option for Sd no of Socket connection */
   #define SD_NO_OF_SOCKET_CONNECTIONS                   12U
   
   /* Pre-compile option for Sd timer unused */
   #define SD_TIMER_UNUSED                               0U
   
   #define SD_SERVICE_GROUP        0U
   
   #define SD_NO_OF_ALLOWED_CLIENT_PROVIDER   1U
   
   #define SD_NO_OF_PROVIDED_SERVER_CONSUMER   1U
   ...
   #define SD_NO_OF_MULTICAST_SO_CON_GRP                 0U

   /* Pre-compile option for sd total size of config option */
   #define SD_TOTAL_SIZE_OF_CONFIG_OPTION                0U
   ...
   #define SD_IPV6_ENABLED                               STD_OFF
    ...
    #define SD_NVMBLOCK_ID                 (66)
    

 #define SD_NO_OF_RAM_ALLOWED_SERVER_CLIENT_PROVIDER_CONSUMER     (4U)
 #define SD_RAM_BLOCK          STD_ON

 
   #define SD_NVM_BLOCK_LENGTH (144U)
    #define SD_NO_OF_ROM_ALLOWED_SERVER_CLIENT_PROVIDER_CONSUMER     (2U)
